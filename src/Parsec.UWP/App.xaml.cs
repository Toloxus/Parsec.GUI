...
using Parsec.UWP.About;
using Parsec.UWP.FilePicker;
using Parsec.UWP.Main;
using System;
    ...
    sealed partial class App : Application
    {
        ...
        private static IServiceProvider ConfigureServices()
        {
            ...
            services.AddSingleton<ILoggingService, LoggingService>((p) => {
                var logFilePath = Path.Combine(ApplicationData.Current.LocalFolder.Path, @"Logs\Log.txt");
                return new LoggingService(logFilePath);
            });
            services.AddSingleton<IWindowFactory, Parsec.UWP.WindowFactory.WindowFactory>();
            ...
            services.AddTransient<IAboutWindow, AboutPage>();
